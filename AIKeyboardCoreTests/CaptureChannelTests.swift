...
final class CaptureChannelTests: XCTestCase {
    ...
    // Record, sweeping, session-lifetime, concurrent-queue, and keyboard-sweep tests
    // live in CaptureChannelSweepTests.swift.
    // Retired-settings and end-reason tests live in CaptureChannelEndTests.swift.
    // Device facts tests live in CaptureDeviceFactsTests.swift.
}
