...
struct MicrophoneStep: View {
    ...
    var body: some View {
        StepLayout(
            ...
            subtitle:
                "iOS does not let a keyboard open the microphone, so aBitBetterKeyboard holds it for you. Start a session on Home, switch to whatever you are writing in, and the mic key on the keyboard works until the session closes."
        ) {
            Card {
                StatusRow(
                    title: "Microphone",
