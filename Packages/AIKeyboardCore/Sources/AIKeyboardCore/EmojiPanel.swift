...
public enum EmojiCatalog {
    ...
    public static let categories: [Category] = [
        Category(id: "Smileys", icon: "face.smiling", emoji: [
            "😀", "😃", "😄", "😁", "😆", "😅", "🤣", "😂", "🙂", "🙃",
            "😉", "😊", "😇", "🥰", "😍", "🤩", "😘", "😗", "😚", "😙",
            "😋", "😛", "😜", "🤪", "😝", "🤗", "🤭", "🤫", "🤔", "🤐",
            "😐", "😑", "😶", "😏", "😒", "🙄", "😬", "😌", "😔", "😪",
        ...
        Category(id: "People", icon: "hand.raised", emoji: [
            "👍", "👎", "👌", "🤌", "✌️", "🤞", "🤟", "🤙", "👈", "👉",
            "👆", "👇", "☝️", "✋", "🤚", "🖐️", "🖖", "👋", "🤝", "🙏",
            "💪", "🦾", "👏", "🙌", "👐", "🤲", "✍️", "💅", "👀", "🧠",
            "👶", "🧒", "👦", "👧", "🧑", "👨", "👩", "🧓", "👴", "👵",
        ...
        Category(id: "Nature", icon: "leaf", emoji: [
            "🐶", "🐱", "🐭", "🐹", "🐰", "🦊", "🐻", "🐼", "🐨", "🐯",
            "🦁", "🐮", "🐷", "🐸", "🐵", "🐔", "🐧", "🐦", "🦆", "🦅",
            "🦉", "🐴", "🦄", "🐝", "🦋", "🐌", "🐞", "🐢", "🐍", "🐙",
            "🌵", "🎄", "🌲", "🌳", "🌴", "🌱", "🌿", "☘️", "🍀", "🌷",
        ...
        Category(id: "Food", icon: "fork.knife", emoji: [
            "🍏", "🍎", "🍐", "🍊", "🍋", "🍌", "🍉", "🍇", "🍓", "🫐",
            "🍈", "🍒", "🍑", "🥭", "🍍", "🥥", "🥝", "🍅", "🥑", "🥦",
            "🥕", "🌽", "🌶️", "🥒", "🥬", "🧄", "🧅", "🍄", "🥜", "🌰",
            "🍞", "🥐", "🥖", "🫓", "🥨", "🧀", "🥚", "🍳", "🥞", "🧇",
        ...
        Category(id: "Activity", icon: "figure.run", emoji: [
            "⚽️", "🏀", "🏈", "⚾️", "🎾", "🏐", "🏉", "🎱", "🏓", "🏸",
            "🥅", "⛳️", "🏹", "🎣", "🥊", "🥋", "🎽", "🛹", "🛼", "🏂",
            "🏋️", "🤸", "🤺", "⛹️", "🤾", "🏌️", "🏇", "🧘", "🏄", "🏊",
            "🚴", "🚵", "🎯", "🎮", "🕹️", "🎲", "🧩", "🎨", "🎭", "🎤",
        ...
        Category(id: "Travel", icon: "car", emoji: [
            "🚗", "🚕", "🚙", "🚌", "🚎", "🏎️", "🚓", "🚑", "🚒", "🚐",
            "🛻", "🚚", "🚛", "🚜", "🛵", "🏍️", "🛺", "🚲", "🛴", "✈️",
            "🚀", "🛸", "🚁", "⛵️", "🚤", "🛥️", "🚢", "🚂", "🚆", "🚊",
            "🗺️", "🗿", "🗽", "🗼", "🏰", "🏯", "🏟️", "🎡", "🎢", "🎠",
        ...
        Category(id: "Objects", icon: "lightbulb", emoji: [
            "⌚️", "📱", "💻", "⌨️", "🖥️", "🖨️", "🖱️", "💽", "💾", "📀",
            "📷", "📹", "🎥", "📞", "☎️", "📟", "📺", "📻", "🧭", "⏱️",
            "⏰", "🔋", "🔌", "💡", "🔦", "🕯️", "🧯", "🛢️", "💸", "💵",
            "💳", "🧾", "✉️", "📩", "📨", "📦", "📪", "📝", "📅", "📊",
        ...
        Category(id: "Symbols", icon: "heart", emoji: [
            "❤️", "🧡", "💛", "💚", "💙", "💜", "🖤", "🤍", "🤎", "💔",
            "❣️", "💕", "💞", "💓", "💗", "💖", "💘", "💝", "✨", "⚡️",
            "🔥", "💥", "💫", "⭐️", "🌟", "☀️", "🌈", "☁️", "❄️", "💧",
            "✅", "❌", "⭕️", "❗️", "❓", "💯", "🔔", "🔕", "♻️", "⚠️",
        ...
        Category(id: "Flags", icon: "flag", emoji: [
            "🇮🇱", "🇺🇸", "🇬🇧", "🇨🇦", "🇦🇺", "🇩🇪", "🇫🇷", "🇪🇸", "🇮🇹", "🇳🇱",
            "🇵🇹", "🇬🇷", "🇹🇷", "🇷🇺", "🇺🇦", "🇵🇱", "🇸🇪", "🇳🇴", "🇩🇰", "🇫🇮",
            "🇨🇭", "🇦🇹", "🇧🇪", "🇮🇪", "🇮🇳", "🇨🇳", "🇯🇵", "🇰🇷", "🇧🇷", "🇦🇷",
            "🇲🇽", "🇿🇦", "🇪🇬", "🇦🇪", "🇸🇦", "🏳️‍🌈", "🏴", "🏁", "🚩", "🎌"
