...
let package = Package(
    ...
    targets: [
        ...
        // `GroupedLexicon-{en,he}.txt` are the frequency lists grouped keys decode
        // against, generated by `Scripts/generate-grouped-lexicon.py` from Leipzig
        // (CC BY 4.0). A resource rather than a generated Swift file because
        // hundreds of KB of string literals is a compile cost paid on every build.
        .target(
