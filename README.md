...
transposition 92, a slip one adjacent key wide 92, and the catch-all "four-plus
letters no dictionary knows, take whatever ranked first" is 68. The setting is
...
107 real misspellings it commits 85 of them and puts a word nobody typed or meant
